...
- Enabled realms salt AzerothCore's client-cache version so clients automatically discard stale cached
  item-query data after this client-visible publication fix; no MPQ or client DBC patch is required.
